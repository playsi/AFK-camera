package net.playsi.Afkcam.settings;

import java.io.*;
import java.util.*;
import lombok.Getter;
import net.playsi.Afkcam.settings.manager.AccessWidenerManager;
import net.playsi.Afkcam.settings.manager.StonecutterManager;
import net.playsi.Afkcam.settings.manager.VersionedGradlePropertiesManager;
