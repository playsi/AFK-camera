package net.playsi.Afkcam.settings.manager;
...
import net.playsi.Afkcam.settings.api.*;
import net.playsi.Afkcam.settings.api.FabricDependenciesAPI;
import net.playsi.Afkcam.settings.api.ModrinthDependenciesAPI;
